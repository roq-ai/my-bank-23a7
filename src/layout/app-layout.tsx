...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiDollarSign } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['account-owner', 'team-member', 'bank-administrator', 'customer-service-representative'];
  ...
  const { data, error, isLoading } = useSWR<BankInterface[]>(
    ...
    () => getBanks({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
